...
for i in "${!oxy_levels[@]}"; do
    ...
    # GRE sequence
    config_filename="${output_dir}/gre_${oxy_levels[$i]}_impermeable.ini"
    seqname="gre_${oxy_levels[$i]}_impermeable"
    ...
    cp "$config_filename" "${output_dir}/gre_${oxy_levels[$i]}_permeable.ini"
    sed -i "s/_impermeable/_permeable/g" "${output_dir}/gre_${oxy_levels[$i]}_permeable.ini"
    sed -i "s/P_XY\[1\] = 0.0 1.0/P_XY[1] = 0.1 1.0/g" "${output_dir}/gre_${oxy_levels[$i]}_permeable.ini"

    # SE sequence
    config_filename="${output_dir}/se_${oxy_levels[$i]}_impermeable.ini"
    seqname="se_${oxy_levels[$i]}_impermeable"
    ...
    cp "$config_filename" "${output_dir}/se_${oxy_levels[$i]}_permeable.ini"
    sed -i "s/_impermeable/_permeable/g" "${output_dir}/se_${oxy_levels[$i]}_permeable.ini"
    sed -i "s/P_XY\[1\] = 0.0 1.0/P_XY[1] = 0.1 1.0/g" "${output_dir}/se_${oxy_levels[$i]}_permeable.ini"

    # bSSFP sequence
    config_filename="${output_dir}/bssfp_${oxy_levels[$i]}_impermeable.ini"
    seqname="bssfp_${oxy_levels[$i]}_impermeable"
    ...
    cp "$config_filename" "${output_dir}/bssfp_${oxy_levels[$i]}_permeable.ini"
    sed -i "s/_impermeable/_permeable/g" "${output_dir}/bssfp_${oxy_levels[$i]}_permeable.ini"
    sed -i "s/P_XY\[1\] = 0.0 1.0/P_XY[1] = 0.1 1.0/g" "${output_dir}/bssfp_${oxy_levels[$i]}_permeable.ini"
done
